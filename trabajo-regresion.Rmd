...
## completar aquí...
ggplot(data = monitor, aes(x = iter, y = J)) +
geom_path(color="red") + xlim(50,3000) + ylim(0.142,0.147)
...
ggplot(subset(monitor, iter > 50 ) , aes(x = iter, y = J))+geom_line() + xlim(0,30000)
```
...
Comentarios: los resultados estimados obtenidos en hacer summary coinciden con los resultados obtenidos con el algoritmo del gradiente.
...
```{r}
## completar aquí
residuos <- residuals(notamediagrados.lm)
residuos
funcioncoste <- mean(residuos^2)
